...
var css =
	".card-notification-link {\n  text-decoration: none;\n  color: #999; }\n\n.card-notification {\n  display: flex;\n  border-bottom: 1px solid rgba(153, 153, 153, 0.3);\n  justify-content: space-between;\n  background-color: #ffffff;\n  font-size: 12px;\n  cursor: pointer;\n  padding: 6px; }\n  .card-notification:hover {\n    background-color: #ebedf0; }\n  .card-notification .content {\n    display: flex;\n    color: black;\n    align-items: center; }\n    .card-notification .content .message {\n      margin: 0 8px;\n      text-align: start; }\n    .card-notification .content .time {\n      color: #999; }\n  .card-notification .image {\n    margin: 5px; }\n    .card-notification .image img {\n      height: 40px;\n      border-radius: 50%; }\n  .card-notification .options {\n    visibility: hidden;\n    text-align: center;\n    font-size: 20px; }\n    .card-notification .options .option {\n      cursor: pointer;\n      opacity: 0.5;\n      color: #999; }\n      .card-notification .options .option:hover {\n        opacity: 1; }\n  .card-notification:hover .options {\n    visibility: visible; }\n";
styleInject(css);
...
var Card = function Card(_ref) {
	...
	return React__default.createElement(
		...
		React__default.createElement(
			"a",
			{ href: detailPage, className: "card-notification-link font-inter" },
			React__default.createElement(
				"div",
				{
				...
				React__default.createElement(
					...
					React__default.createElement("div", { className: classes.text }, message),
					receivedTime &&
						React__default.createElement(
							"div",
...
var Spinner = function Spinner() {
	return React__default.createElement(
		"div",
		{ className: "spinner" },
		React__default.createElement("div", { className: "loaders" }, "Loading...")
	);
};
...
var Notifications = (function (_Component) {
	...
	function Notifications(props) {
		...
		var _this = possibleConstructorReturn(
			this,
			(Notifications.__proto__ || Object.getPrototypeOf(Notifications)).call(this, props)
		);
					...
					if (notificationRef.offsetLeft > notificationRef.offsetWidth) {
						this.setState({
							styles: _extends$1({}, styles, {
								transform:
									"translateX(-" + (notificationRef.offsetWidth - 20) + "px)",
							}),
						});
					}
					...
					var cardList =
						...
						(CustomComponent
							? data.map(function (item) {
									return React__default.createElement(
										CustomComponent,
										_extends$1({ key: item.message }, _this4.props, {
											data: item,
										})
									);
							  })
							...
							notificationCount > 0 &&
								React__default.createElement(
									"div",
									{
										...
										style:
											notificationCount >= 100 ? { fontSize: "8px" } : null,
									},
...
var _initialiseProps = function _initialiseProps() {
	...
	this.fetchData = function () {
		...
		_this5.setState({ loading: true }, function () {
			...
			_this5.setState({
				loading: false,
				data: [].concat(toConsumableArray(data), toConsumableArray(fetchedData)),
			});
		});
	};
...
Notifications.propTypes = {
	...
	notificationCard: PropTypes.oneOfType([
		PropTypes.func,
		PropTypes.instanceOf(React__default.Component),
	]),
